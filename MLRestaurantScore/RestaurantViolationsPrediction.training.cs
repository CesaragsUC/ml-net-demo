...
namespace MLRestaurantScore
{
    ...
    {
        public const string RetrainFilePath =  @"G:\DevProjetos\AI\MLSampleApp\MLRestaurantScore\Data\RestaurantScores\RestaurantScores.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=11,MinimumExampleCountPerLeaf=26,NumberOfTrees=4,MaximumBinCountPerFeature=217,FeatureFraction=0.9317154866029803,LearningRate=0.9999997766729865,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"RiskCategory"))      
